                ...
                <form onSubmit={HandleReceiveGoods} className="p-8">
                          ...
                          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            ...
                            <div className="w-full md:w-48 pt-4 md:pt-0 border-t md:border-t-0 border-white/5">
                              ...
                              <div className="relative">
                                ...
                                />
                                <div className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-muted italic">
                                  Units
                                </div>
                              </div>
                            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div className="space-y-1">
                      ...
                      <input
                        type="text"
                        value={receivePackingSlip}
                        onChange={(e) => setReceivePackingSlip(e.target.value)}
                        placeholder="Enter packing slip or delivery note"
